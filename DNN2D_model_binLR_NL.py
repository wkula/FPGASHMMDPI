...
if __name__ == "__main__":
    logging.basicConfig(filename='./DNN2D_model_binLR_NL.log', level=logging.INFO)
    ...
    # model = tf.keras.models.load_model('DNN_2D_binLR_NL.h5')
    ...
    csv_logger = CSVLogger('./DNN2D_model_binLR_NL_epochs.log', append=True, separator=';')
