...
if __name__ == "__main__":
    logging.basicConfig(filename='./RNN2D_model_binLR.log', level=logging.INFO)
    ...
    model = tf.keras.models.load_model('RNN_2D_binLR.h5')
    ...
    checkpoint_filepath = './tmpRNN/checkpoint'
    ...
    csv_logger = CSVLogger('./RNN2D_model_binLR_epochs.log', append=True, separator=';')
