...
def DNN_model(shape=(9, 8)):
    ...
    y = tf.keras.layers.Conv1DTranspose(128, 3, activation='linear')(din)
    y = tf.keras.layers.Dropout(0.2)(y)
    y = tf.keras.layers.Conv1DTranspose(64, 3, activation='linear')(y)
    y = tf.keras.layers.Dropout(0.2)(y)
...
if __name__ == "__main__":
    logging.basicConfig(filename='./RCNN2D_model_binLR.log', level=logging.INFO)
    ...
    # model = tf.keras.models.load_model('RCNN_2D_binLR.h5')
    ...
    checkpoint_filepath = './tmpRCNN/checkpoint'
    ...
    csv_logger = CSVLogger('./RCNN2D_model_binLR_epochs.log', append=True, separator=';')
